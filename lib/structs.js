...
module.exports = function () {
  ...
  var override = (0, _assign2.default)({}, authorityOverride, abiOverride(structLookup), wasmCodeOverride(config), actionDataOverride(structLookup, forceActionDataHex), config.override);
...
function precisionCache(assetCache, value) {
  ...
  var pc = (0, _assign2.default)({}, symbolInfo, { contract: contract });
  if (precision != null) {
    ...
    return {
      ...
      fromObject: function fromObject(value) {
        ...
        if (typeof value === 'string') {
          (0, _assign2.default)(asset, parseExtendedAsset(value));
        } else if ((typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) === 'object') {
          (0, _assign2.default)(asset, value);
        } else {
