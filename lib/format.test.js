...
describe('format', function () {
  ...
  it('parseExtendedAsset', function () {
    ...
    try {
      for (var _iterator7 = (0, _getIterator3.default)(parseExtendedAssets), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
